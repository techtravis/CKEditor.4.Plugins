       ...
       editor.widgets.add('bootstrapgrid',
         {
           ...
           createGrid: function(rowLayout, row, rowNumber, colCount) {
               var content = '<div rowLayout="' + rowLayout +'" class="row row-' + rowNumber + '">';
                    if(rowLayout == '12c') {
                        content = content +
                                   '<div class="col col-md-12 col-md-offset-0 col-lg-12 col-lg-offset-0 col-xl-10 col-xl-offset-1">' +
                        ...
                        content = content +
                                   '<div class="col col-md-4 col-md-offset-4 col-lg-2 col-lg-offset-5">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="col-lg-12">' +
                                   '            <div class="content">' +
                                   '                <p>Col 1 content area</p>' +
                        ...
                        content = content +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-2 col-lg-2 col-lg-offset-1">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="col-lg-12">' +
                                   '            <div class="content">' +
                                   '                <p>Col 2 content area</p>' +
                                   ...
                                   '    </div>' +                                   
                                   '</div>' +
                                   '<div class="col col-md-5 col-lg-4 col-lg-offset-1">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="pull-right-lg">' +
                                   '            <div class="col-md-12">' +
                                   '                <div class="content">' +
                        ...
                        content = content +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-5 col-md-offset-2 col-lg-4 col-lg-offset-4">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="pull-right-lg">' +
                                   '            <div class="col-md-12">' +
                                   '                <div class="content">' +
                        ...
                        content = content +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-3 col-md-offset-2 col-lg-2 col-lg-offset-4">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="col-md-12">' +
                                   '            <div class="content">' +
                                   '                <p>Col 3 content area</p>' +
                        ...
                        content = content +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-4 col-md-offset-1 col-lg-4 col-lg-offset-2">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="col-md-12">' +
                                   '            <div class="content">' +
                                   '                <p>Col 2 content area</p>' +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-3 col-md-offset-1 col-lg-2 col-lg-offset-2">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="col-md-12">' +
                                   '            <div class="content">' +
                                   '                <p>Col 3 content area</p>' +
                        ...
                        content = content +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-2 col-md-offset-1 col-lg-2 col-lg-offset-2">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="col-md-12">' +
                                   '            <div class="content">' +
                                   '                <p>Col 2 content area</p>' +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-4 col-md-offset-1 col-lg-3 col-lg-offset-2">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="col-md-12">' +
                                   '            <div class="content">' +
                                   '                <p>Col 3 content area</p>' +
                        ...
                        content = content +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-5 col-md-offset-2 col-lg-5 col-lg-offset-2">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="col-md-12">' +
                                   '            <div class="content">' +
                                   '                <p>Col 2 content area</p>' +
                        ...
                        content = content +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-2 col-md-offset-4 col-lg-2 col-lg-offset-4">' +
                                   '    <div class="row outer-content">' +
                                   '        <div class="pull-right-lg">' +
                                   '            <div class="col-md-12">' +
                                   '                <div class="content">' +
                        ...
                        content = content +
                                   ...
                                   '    </div>' +  
                                   '</div>' +
                                   '<div class="col col-md-6 col-md-offset-4 col-lg-6 col-lg-offset-4">' +
                                   '    <div class="row outer-content pull-right-lg">' +
                                   '        <div class="pull-right-lg">' +
                                   '            <div class="col-md-12">' +
                                   '                <div class="content">' +
                                   '                    <p>Col 2 content area</p>' +
